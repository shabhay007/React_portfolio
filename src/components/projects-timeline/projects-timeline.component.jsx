...
import L_PortfolioUsingReactjs from "../../assets/img/projects/folio.png";
    ...
    <div>
      ...
      <Timeline>
        <Events>
          ...
          >
            <div className="d-flex justify-content-between flex-column mt-1">
              ...
              <div className="d-flex justify-content-between flex-nowrap text-center">
                <UrlButton
                  href="https://abhay-todo.onrender.com/"
                  target="_blank"
                >
                  SEE LIVE
                </UrlButton>
                <UrlButton
                  href="https://github.com/shabhay007/Todo-List-React"
                  target="_blank"
                >
                  SOURCE CODE
                </UrlButton>
          ...
          <ImageEvent
            className="text-center"
            text="Portfolio using Reactjs"
            src={L_PortfolioUsingReactjs}
            alt="Portfolio using Reactjs"
          >
            <div className="d-flex justify-content-between flex-column mt-1">
              <div>
                <Accordion>
                    ...
                    <Accordion.Collapse eventKey="0" className="text-left">
                      <Card.Body>
                        ...
                        <ul className="list-styles pt-1">
                          ...
                          {/* <li>Write a blog</li> */}
                          <li>
                            Hosted using Render under www.aksfun.com
                          </li>
                        </ul>
                        <hr />
                        <strong>Tech used:</strong>
