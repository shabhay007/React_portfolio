          ...
          <Row className="pt-3 pb-5 align-items-center">
            ...
            <Col xs={12} md={6}>
              <Row className=" align-items-start p-2 my-details rounded">
                Hi there! I am <strong>&nbsp;Abhay Kumar Sharma</strong>
                <br />A passionate programmer and a Coach, born and brought up
                in India. I am a Full Stack Developer with React.js, Node.js, 
                and SQL as my tech stack.
                <br />
                In 2023, I will become a graduate in Engineering with
                ...
                products that makes a positive impact to the society.
                <br /> <br />
                <Col className="d-flex justify-content-center flex-wrap">
                  ...
                  <div>
                    <a
                      href="https://drive.google.com/file/d/1OZ-5vox1ZSNJlh8_GLCyf7E7jxgtm_XL/view?usp=share_link"
                      target="_blank"
                  ...
                  <div>
                    <a
                      href="https://github.com/shabhay007"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                  ...
                  <div>
                    <a
                      href="https://www.linkedin.com/in/abhay-sharma-8840a2220/"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
